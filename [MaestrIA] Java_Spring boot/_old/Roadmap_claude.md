...
| --- | --- | --- | --- |
| Month 1 | 01–30 | Java Core + Spring Core/Boot fundamentals | 🟡 in progress (10/30 done) |
...
### Week 2 — Days 07–12 🟡 in progress (4/6 done)
...
| 10 | ✅ | Custom exceptions + try-with-resources (practical) | `@Configuration` + `@Bean` explicit config | java: exception-handling (practical) · spring-boot: configuration | [Day 10](<[Day 10] Custom Exceptions, Try-With-Resources &.md>) |
